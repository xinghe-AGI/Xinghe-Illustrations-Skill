...
9. 验收返工：读取 `qa-checklist.md` 和 `visual-qa-rubric.md`；需要校准评分或解释返工原因时读 `visual-qa-scoring-examples.md`；封面任务再读 `cover-qa-checklist.md`；失败返工读 `failure-recovery-playbook.md`。
