...
- **视觉质量评分**：新增 12 分制 QA rubric，从路由、信息、文字、人物、构图和风格边界评估图片是否可发布。
- **视觉学习日志**：当人工确认某张图效果好时，可沉淀为学习日志条目，后续再决定是否升级成长期规则。
- **仓库自动校验**：通过 GitHub Actions 检查 CLI 语法、manifest JSON、README 图片路径和 `SKILL.md` 元数据。
...
<table>
  <tr>
    ...
    <td width="33%">
      <strong>解释图：因果链</strong><br>
      <img src="assets/readme-showcase/03a-explanatory-cause-effect.png" alt="解释图：因果链">
    </td>
    <td width="33%">
...
<table>
  <tr>
    ...
    <td width="33%">
      <strong>分层架构图</strong><br>
      <img src="assets/readme-showcase/05a-architecture-layered-agent.png" alt="技术架构图：分层架构">
    </td>
    <td width="33%">
      <strong>中心辐射架构图</strong><br>
      <img src="assets/readme-showcase/05b-architecture-hub-spoke.png" alt="技术架构图：中心辐射">
    </td>
  </tr>
</table>
...
<table>
  <tr>
    ...
    <td width="33%">
      <strong>SOP 流程图</strong><br>
      <img src="assets/readme-showcase/06a-process-sop-flow.png" alt="流程图：SOP">
    </td>
    <td width="33%">
      <strong>反馈闭环图</strong><br>
      <img src="assets/readme-showcase/06b-process-feedback-loop.png" alt="流程图：反馈闭环">
    </td>
  </tr>
</table>
...
<table>
  <tr>
    ...
    <td width="33%">
      <strong>误解解除漫画</strong><br>
      <img src="assets/readme-showcase/07a-comic-misunderstanding.png" alt="多格漫画：误解解除">
    </td>
    <td width="33%">
      <strong>前后变化漫画</strong><br>
      <img src="assets/readme-showcase/07b-comic-before-after.png" alt="多格漫画：前后变化">
    </td>
  </tr>
</table>
...
<table>
  <tr>
    ...
    <td width="33%">
      <strong>能力矩阵信息图</strong><br>
      <img src="assets/readme-showcase/08a-infographic-matrix.png" alt="信息图：能力矩阵">
    </td>
    <td width="33%">
      <strong>路线图信息图</strong><br>
      <img src="assets/readme-showcase/08b-infographic-roadmap.png" alt="信息图：路线图">
    </td>
  </tr>
</table>
