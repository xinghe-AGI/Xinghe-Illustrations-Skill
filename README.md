...
Xinghe Illustrations Skill 用于把中文内容转成可发布的视觉方案、prompt、manifest 和图片资产，适合文章配图、公众号封面、小红书封面、情绪图、解释图、知识卡片、技术架构图、流程图、多格漫画和信息图。
...
完整配置、inspect 检查和生成命令见 [docs/usage-and-generation.md](docs/usage-and-generation.md)。
